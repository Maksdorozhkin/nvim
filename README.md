...
| **lualine.nvim** | Статус-строка с темой Oxocarbon |
| **barbar.nvim** | Вкладки открытых файлов сверху (табы) |
| **neo-tree.nvim** | Боковое файловое дерево с навигацией и управлением файлами |
...
| **mason-lspconfig.nvim** | Автоматическая конфигурация LSP |
| **nvim-lspconfig** | Настройка LSP-серверов |
| **nvim-cmp** | Автодополнение (LSP + сниппеты LuaSnip) |
...
| Плагин | Назначение |
|--------|-----------|
| **todo-comments.nvim** | Подсветка и навигация по TODO/FIXME/HACK/WARN заметкам в коде |
